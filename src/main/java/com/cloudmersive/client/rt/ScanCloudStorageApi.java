...
@Component("com.cloudmersive.client.rt.ScanCloudStorageApi")
public class ScanCloudStorageApi {
     ...
     */
    public CloudStorageVirusScanResult scanCloudStorageScanAwsS3File(String accessKey, String secretKey, String bucketRegion, String bucketName, String keyName) throws RestClientException {
        return scanCloudStorageScanAwsS3FileWithHttpInfo(accessKey, secretKey, bucketRegion, bucketName, keyName).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<CloudStorageVirusScanResult> scanCloudStorageScanAwsS3FileWithHttpInfo(String accessKey, String secretKey, String bucketRegion, String bucketName, String keyName) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/aws-s3/single", Collections.<String, Object>emptyMap());
        ...
        ParameterizedTypeReference<CloudStorageVirusScanResult> returnType = new ParameterizedTypeReference<CloudStorageVirusScanResult>() {};
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<CloudStorageAdvancedVirusScanResult> scanCloudStorageScanAwsS3FileAdvancedWithHttpInfo(String accessKey, String secretKey, String bucketRegion, String bucketName, String keyName, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        Object postBody = null;
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/aws-s3/single/advanced", Collections.<String, Object>emptyMap());
        ...
        ParameterizedTypeReference<CloudStorageAdvancedVirusScanResult> returnType = new ParameterizedTypeReference<CloudStorageAdvancedVirusScanResult>() {};
        return apiClient.invokeAPI(path, HttpMethod.POST, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, contentType, authNames, returnType);
    }
    /**
    ...
    public ResponseEntity<CloudStorageVirusScanResult> scanCloudStorageScanAzureBlobWithHttpInfo(String connectionString, String containerName, String blobPath) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/azure-blob/single", Collections.<String, Object>emptyMap());
    ...
    public CloudStorageAdvancedVirusScanResult scanCloudStorageScanAzureBlobAdvanced(String connectionString, String containerName, String blobPath, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        return scanCloudStorageScanAzureBlobAdvancedWithHttpInfo(connectionString, containerName, blobPath, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, restrictFileTypes).getBody();
    }
    ...
    public ResponseEntity<CloudStorageAdvancedVirusScanResult> scanCloudStorageScanAzureBlobAdvancedWithHttpInfo(String connectionString, String containerName, String blobPath, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/azure-blob/single/advanced", Collections.<String, Object>emptyMap());
    ...
    public ResponseEntity<CloudStorageVirusScanResult> scanCloudStorageScanGcpStorageFileWithHttpInfo(String bucketName, String objectName, org.springframework.core.io.Resource jsonCredentialFile) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/gcp-storage/single", Collections.<String, Object>emptyMap());
    ...
    public CloudStorageAdvancedVirusScanResult scanCloudStorageScanGcpStorageFileAdvanced(String bucketName, String objectName, org.springframework.core.io.Resource jsonCredentialFile, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        return scanCloudStorageScanGcpStorageFileAdvancedWithHttpInfo(bucketName, objectName, jsonCredentialFile, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, restrictFileTypes).getBody();
    }
    ...
    public ResponseEntity<CloudStorageAdvancedVirusScanResult> scanCloudStorageScanGcpStorageFileAdvancedWithHttpInfo(String bucketName, String objectName, org.springframework.core.io.Resource jsonCredentialFile, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/gcp-storage/single/advanced", Collections.<String, Object>emptyMap());
    ...
    public ResponseEntity<CloudStorageVirusScanResult> scanCloudStorageScanSharePointOnlineFileWithHttpInfo(String clientID, String clientSecret, String sharepointDomainName, String siteID, String filePath, String tenantID, String itemID) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/sharepoint-online/site/single", Collections.<String, Object>emptyMap());
    ...
    public CloudStorageAdvancedVirusScanResult scanCloudStorageScanSharePointOnlineFileAdvanced(String clientID, String clientSecret, String sharepointDomainName, String siteID, String tenantID, String filePath, String itemID, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        return scanCloudStorageScanSharePointOnlineFileAdvancedWithHttpInfo(clientID, clientSecret, sharepointDomainName, siteID, tenantID, filePath, itemID, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, restrictFileTypes).getBody();
    }
    ...
    public ResponseEntity<CloudStorageAdvancedVirusScanResult> scanCloudStorageScanSharePointOnlineFileAdvancedWithHttpInfo(String clientID, String clientSecret, String sharepointDomainName, String siteID, String tenantID, String filePath, String itemID, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, String restrictFileTypes) throws RestClientException {
        ...
        String path = apiClient.expandPath("/virus/scan/cloud-storage/sharepoint-online/site/advanced", Collections.<String, Object>emptyMap());
