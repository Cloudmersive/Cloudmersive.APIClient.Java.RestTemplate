...
public class BarcodeLookupApi extends BaseApi {
    ...
    public ResponseEntity<BarcodeLookupResponse> barcodeLookupEanLookupWithHttpInfo(String value) throws RestClientException {
        ...
        ParameterizedTypeReference<BarcodeLookupResponse> localReturnType = new ParameterizedTypeReference<BarcodeLookupResponse>() {};
        return apiClient.invokeAPI("/barcode/lookup/ean", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
