...
public class TextGenerationApi extends BaseApi {
    ...
    public ResponseEntity<Object> textGenerationCreateHandwritingPngWithHttpInfo(CreateHandwritingRequest request) throws RestClientException {
        ...
        return apiClient.invokeAPI("/image/text/create/handwriting/png", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
