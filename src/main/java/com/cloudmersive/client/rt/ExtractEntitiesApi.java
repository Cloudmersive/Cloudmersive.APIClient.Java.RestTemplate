...
public class ExtractEntitiesApi extends BaseApi {
    ...
    public ResponseEntity<ExtractEntitiesResponse> extractEntitiesPostWithHttpInfo(ExtractEntitiesRequest value) throws RestClientException {
        ...
        ParameterizedTypeReference<ExtractEntitiesResponse> localReturnType = new ParameterizedTypeReference<ExtractEntitiesResponse>() {};
        return apiClient.invokeAPI("/nlp-v2/extract-entities", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
